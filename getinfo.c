...
/**
 * set_info - Initializes the `info_t` structure with given arguments.
 * @info: Pointer to the `info_t` structure to initialize.
 * @av: The argument vector to set in the `info_t` structure.
 */
 ...
 * @all: If true, frees all fields; otherwise, frees only selected fields.
 */
